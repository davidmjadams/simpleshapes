---
title: "Slop Defence: holding back the entropy"
date: 2026-05-01
draft: true
...
There’s an important question when it comes to using agents to code that hasn’t been answered yet. 

It’s clear starting software has changed forever. What’s less clear is what happens next? 
...
By guardrails, I mean proper testing at all levels, well-defined tasks, constraints, and scoping.
...
Because after all, it doesn’t “know” anything. It can’t “know” anything. It’s just unbelievably good at predicting the next token. But it's statistics, not knowledge, and that facade of understanding can be dangerous. _You_ _do_ know, so if you’re going to hand off the building to a machine, please ensure you have guardrails that _you_ define. You control. You _understand_. 
